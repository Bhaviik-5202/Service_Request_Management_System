...
const faqs = [
  {
    ...
    a: "Click on 'Service Requests' in the sidebar and press the 'New Request' button. Fill out the title, department, priority, and description, then click Submit.",
  },
  {
    q: "How long does it take for a request to be assigned?",
    a: "Standard requests are reviewed by HODs and assigned to technicians within 2-4 business hours based on SLA rules.",
  },
  {
    q: "Can I request hardware or software upgrades?",
    a: "Yes, select 'Hardware Request' or 'Software Request' from the Request Type dropdown. These requests will route for HOD approval automatically.",
  },
  {
    q: "How do I track the status of my ticket?",
    a: "Go to your Service Requests dashboard to view live status updates, technician remarks, and full conversation history.",
  },
];
          ...
          >
            ...
            <div className="mt-4 grid gap-3 sm:grid-cols-2">
              {docs.map((d) => (
                <button
                  key={d.title}
                  onClick={() => toast.info("Documentation guide")}
                  className="group flex items-start gap-3 rounded-xl border p-4 text-left transition-all hover:-translate-y-0.5 hover:border-primary/40 hover:shadow-md cursor-pointer"
                >
