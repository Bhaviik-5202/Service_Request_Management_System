  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      ...
      >
        ...
        <h1 className="text-8xl font-black tracking-tighter mt-4 bg-gradient-to-r from-primary via-info to-success bg-clip-text text-transparent font-display">
          404
        </h1>
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      ...
      >
        ...
        <p className="mt-3 text-sm text-muted-foreground leading-relaxed">
          We encountered an unexpected crash while rendering this section.
        </p>
